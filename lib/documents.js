...
const brandLogo=readFileSync(new URL('../assets/logo-jaqueline-hires.png',import.meta.url));
...
function documentChildren(item){
  ...
  const out=[
    new Paragraph({spacing:{after:100},children:[new ImageRun({data:brandLogo,transformation:{width:245,height:100},type:'png',altText:{title:'Jaqueline Vieira Psicóloga',description:'Identidade visual da profissional',name:'Logo'}})]}),
    paragraph('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',{color:accent,spaceAfter:260}),
