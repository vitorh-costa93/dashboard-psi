...
const PSM_TOYS=[
  {name:'Blocos',bg:'#fbf0c8',fg:'#c99a2e',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"><rect x="4" y="12.5" width="7" height="7" rx="1"/><rect x="13" y="12.5" width="7" height="7" rx="1"/><rect x="8.5" y="4" width="7" height="7" rx="1"/></svg>'},
  {name:'Pipa',bg:'#e4eef7',fg:'#6e9dc4',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3 18 10 12 21 6 10z"/><path d="M6 10h12M12 3v18"/><path d="M12 21c.8.9.8 1.8 0 2.7"/></svg>'},
  {name:'Bola',bg:'#fbe4e1',fg:'#d97066',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><circle cx="12" cy="12" r="8"/><path d="M12 4c3 3 3 13 0 16M4 12c3-3 13-3 16 0"/></svg>'},
  {name:'Catavento',bg:'#eee6f7',fg:'#a784cc',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 12 4.5 8.5c0-3 2.7-4.8 5.7-3.8z"/><path d="M12 12 15.5 4.5c3 0 4.8 2.7 3.8 5.7z"/><path d="M12 12 19.5 15.5c0 3-2.7 4.8-5.7 3.8z"/><path d="M12 12 8.5 19.5c-3 0-4.8-2.7-3.8-5.7z"/><circle cx="12" cy="12" r="1.3" fill="currentColor" stroke="none"/></svg>'},
  {name:'Ursinho',bg:'#e7f2e0',fg:'#7fa968',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="7.3" cy="6.3" r="2"/><circle cx="16.7" cy="6.3" r="2"/><circle cx="12" cy="13.5" r="7"/><circle cx="9.3" cy="12.5" r=".4" fill="currentColor" stroke="none"/><circle cx="14.7" cy="12.5" r=".4" fill="currentColor" stroke="none"/><path d="M10 16.3c1.2 1 2.8 1 4 0"/></svg>'},
];
