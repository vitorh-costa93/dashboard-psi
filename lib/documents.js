...
<div style="width:100%;box-sizing:border-box;padding:12px 42px 0;font-family:'DM Sans',Arial,sans-serif;-webkit-print-color-adjust:exact;print-color-adjust:exact;">
<div style="display:flex;align-items:center;">
<div style="width:44px;height:44px;border-radius:50%;background:${colorido===false?'#b8b8b8':'#b7c3a5'};display:flex;align-items:center;justify-content:center;flex-shrink:0;">
<img src="${brandSymbolWhiteUri}" style="width:28px;height:25px;object-fit:contain;filter:brightness(0) invert(1);">
</div>
<div style="margin-left:10px;line-height:1.05;font-family:'Agrandir Tight','Arial Narrow',sans-serif;color:#6b6b70;">
<div style="font-size:12px;font-weight:700;">Jaqueline Vieira</div>
<div style="font-size:6.5px;font-weight:700;margin-top:3px;">PSICÓLOGA&nbsp;&nbsp;CRP 06/191478</div>
</div>
</div>
<div style="text-align:center;font-size:11.5px;font-weight:700;color:#626267;margin:8px 0 6px;font-family:'Agrandir Tight','Arial Narrow',sans-serif;">${escHtml(title)}</div>
