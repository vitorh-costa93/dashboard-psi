...
const PSM_TEXT={
  ...
  infantil:{
    abordagem:['Através da TCC será possível identificar as crenças disfuncionais que levam aos pensamentos mal adaptativos, influenciando as emoções e o comportamento do paciente.','Ao longo das sessões, o objetivo é auxiliar o paciente a avaliar esses pensamentos de forma adaptativa, trazendo uma mudança das reações – comportamental, emocional e fisiológica.'],
    endereco:{nome:'Av. Armando Corrêa de Siqueira, 1104',linhas:['Bairro: Vila Harmonia']},
    agendamento:['Tolerância de atraso é de 15 minutos','Cancelamento deve ser feito 24 horas antes','Mudanças de horário devem ser comunicadas em até 72 horas antes da terapia, sendo possível de acordo com a disponibilidade do psicólogo','A partir de duas faltas consecutivas, sem aviso durante o tratamento, o atendimento será considerado interrompido e o cliente poderá perder sua vaga preferencial de horário.'],
  },
};
const PSM_PAGAMENTO=['Qualquer alteração do valor somente poderá acontecer com o conhecimento e acordo entre as partes','Sessões em que o cliente não comparece, sem aviso antecipado, serão cobradas normalmente, salvo, motivos de extrema urgência','O valor dos honorários pode ser revisto a cada 6 meses','O contrato poderá ser rescindido por qualquer uma das partes a qualquer momento e não será cobrado nenhuma multa ou qualquer outro tipo de ônus.'];
...
function psmPdfHtmlKidsEmotion(individual,pacote){
  const asset=name=>dataUri(readFileSync(new URL(`../assets/psm/infantil/native/${name}`,import.meta.url)),'image/webp');
  const A={coverMain:asset('cover-main.webp'),coverBlue:asset('cover-blue.webp'),yellow:asset('values-mascot.webp'),tcc:asset('tcc-art.webp'),online:asset('online-art.webp'),presScene:asset('presencial-scene.webp'),presCast:asset('presencial-cast.webp'),agenda:asset('agenda-mascot.webp'),payment:asset('payment-mascot.webp'),contact:asset('contact-art.webp'),socialMain:asset('social-main.webp'),socialLeft:asset('social-left.webp'),close:asset('closing-art.webp')};
...
.psm-emov2{position:relative;width:100%;height:100%;overflow:hidden;background:#fef6ea;color:#262226;font-family:'Trebuchet MS',Arial,sans-serif;container-type:inline-size;isolation:isolate}
...
.psm-emov2 .em-num{position:absolute;z-index:10;left:2.2cqw;top:2.2cqw;width:4.2cqw;height:4.2cqw;border-radius:50%;display:flex;align-items:center;justify-content:center;background:#73528e;color:#fff;font:700 1.65cqw 'Trebuchet MS',Arial,sans-serif;box-shadow:0 .3cqw .8cqw rgba(84,50,103,.15)}
.psm-emov2 .em-title{position:relative;z-index:3;margin:0;color:#70468d;font:400 5.15cqw/.95 'Adlery Pro','Playfair Display',serif;letter-spacing:.01em}.psm-emov2 .em-kicker{color:#0f8782;font:700 2.05cqw/1.2 'Trebuchet MS',Arial,sans-serif}.psm-emov2 .em-body{color:#272327;font:400 1.52cqw/1.48 'DM Sans',Arial,sans-serif}.psm-emov2 .em-body strong{font-weight:700}.psm-emov2 .em-head{position:absolute;z-index:5;left:6.2cqw;top:5.2cqw}.psm-emov2 .em-art{position:absolute;z-index:2;display:block;object-fit:contain}.psm-emov2 .em-star,.psm-emov2 .em-heart{position:absolute;z-index:1;line-height:1}.psm-emov2 .em-star{color:#edc14a;font-size:2.1cqw}.psm-emov2 .em-heart{color:#ed7896;font-size:2.4cqw}
...
/* capa */
.psm-emov2-cover .em-copy{position:absolute;z-index:6;left:5.3cqw;top:18.4cqw;width:39cqw}.psm-emov2-cover .em-name{color:#70468d;font:700 7.2cqw/.94 'Segoe Print','Comic Sans MS','Bradley Hand',cursive}.psm-emov2-cover .em-role{display:inline-block;margin-top:2.1cqw;padding:1.02cqw 2.35cqw;border-radius:999px;background:#ee7d9a;color:#fff;font:700 2.05cqw 'Trebuchet MS',Arial,sans-serif}.psm-emov2-cover .em-crp{margin-top:1.45cqw;width:19cqw;text-align:center;color:#0f8782;font:700 1.7cqw 'Trebuchet MS',Arial,sans-serif}.psm-emov2-cover .cover-main{right:-.4cqw;bottom:-.2cqw;width:55cqw;height:65cqw}.psm-emov2-cover .cover-blue{left:19.7cqw;bottom:8.2cqw;width:12.5cqw;height:18.5cqw;z-index:4;filter:drop-shadow(0 .4cqw .6cqw rgba(80,60,50,.08))}.psm-emov2-cover .cover-yellow{left:15.2cqw;bottom:-.3cqw;width:17.5cqw;height:22cqw;z-index:5;filter:drop-shadow(0 .4cqw .6cqw rgba(80,60,50,.08))}
/* tcc */
.psm-emov2-tcc .em-head{left:5.4cqw;top:4.8cqw;padding:.35cqw 1.5cqw .45cqw;border-radius:999px;background:#eadff3}.psm-emov2-tcc .em-title{font-size:4.2cqw}.psm-emov2-tcc .em-copy{position:absolute;z-index:4;left:5cqw;top:17.6cqw;width:49.5cqw}.psm-emov2-tcc .em-kicker{font-size:2cqw;margin-bottom:2cqw}.psm-emov2-tcc .em-body{font-size:1.37cqw;line-height:1.48}.psm-emov2-tcc .em-art{right:3.8cqw;top:17.3cqw;width:35cqw;height:35.5cqw}.psm-emov2-tcc .diagram-label{position:absolute;z-index:5;color:#201f20;font:700 1.12cqw 'Trebuchet MS',Arial,sans-serif}.psm-emov2-tcc .dl1{right:27.2cqw;top:13.5cqw}.psm-emov2-tcc .dl2{right:8.1cqw;top:13.5cqw}.psm-emov2-tcc .dl3{right:7.2cqw;top:51.9cqw}.psm-emov2-tcc .dl4{right:28.2cqw;top:51.9cqw}.psm-emov2-tcc .em-caption{position:absolute;z-index:5;right:5.8cqw;bottom:3.6cqw;color:#0f8782;font:400 3.1cqw/.96 'Adlery Pro',serif;text-align:center}
/* online */
.psm-emov2-online .em-copy{position:absolute;z-index:4;left:4.4cqw;top:18.6cqw;width:43cqw}.psm-emov2-online .em-body{font-size:1.53cqw;line-height:1.48}.psm-emov2-online .em-art-wrap:before{content:'';position:absolute;z-index:1;right:-5cqw;top:9cqw;width:57cqw;height:58cqw;border-radius:50% 0 0 50%;background:#eef6f2}.psm-emov2-online .em-art{right:0;bottom:-.2cqw;width:47.5cqw;height:63cqw}.psm-emov2-online .meet-bubble{position:absolute;z-index:6;left:47.4cqw;top:29cqw;width:7.3cqw;height:7.3cqw;border-radius:50%;background:#fff;display:flex;align-items:center;justify-content:center;box-shadow:0 .4cqw 1.2cqw rgba(72,66,60,.09)}.psm-emov2-online .meet-mark{position:relative;width:4.1cqw;height:3.2cqw}.psm-emov2-online .meet-mark i{position:absolute;display:block}.psm-emov2-online .meet-mark .m1{left:0;top:.45cqw;width:2.35cqw;height:2.3cqw;background:#2e72d2}.psm-emov2-online .meet-mark .m2{left:.55cqw;top:0;width:1.75cqw;height:1.2cqw;background:#f6b91b}.psm-emov2-online .meet-mark .m3{left:.55cqw;bottom:0;width:1.75cqw;height:1.1cqw;background:#e9564a}.psm-emov2-online .meet-mark .m4{right:0;top:.4cqw;border-top:1.2cqw solid transparent;border-bottom:1.2cqw solid transparent;border-right:0;border-left:1.45cqw solid #29a95f}.psm-emov2-online .req-title{position:absolute;z-index:5;left:7.2cqw;top:44.4cqw;color:#70468d;font:700 3.35cqw 'Segoe Print','Comic Sans MS','Bradley Hand',cursive}.psm-emov2-online .reqs{position:absolute;z-index:5;left:4.5cqw;bottom:3.7cqw;display:flex;gap:2.5cqw}.psm-emov2-online .req{width:16.8cqw;height:14.6cqw;border-radius:2.4cqw;background:#fff0c4;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;font:700 1.12cqw/1.35 'DM Sans',Arial,sans-serif;box-shadow:0 .35cqw 1cqw rgba(90,70,25,.04)}.psm-emov2-online .req .em-icon{width:5cqw;height:5cqw;margin-bottom:.8cqw;color:#42a49f}.psm-emov2-online .req:nth-child(2) .em-icon{color:#d87947}
/* presencial */
.psm-emov2-pres .em-copy{position:absolute;z-index:6;left:4.6cqw;top:18.6cqw;width:45cqw}.psm-emov2-pres .em-body{font-size:1.5cqw}.psm-emov2-pres .address{margin-top:2.25cqw;padding:1.9cqw 2.25cqw;border-radius:2.2cqw;background:rgba(254,246,234,.96)}.psm-emov2-pres .address strong{display:block;color:#70468d;font:700 2.05cqw 'Trebuchet MS',Arial,sans-serif;margin-bottom:.55cqw}.psm-emov2-pres .scene-art{position:absolute;z-index:1;right:0;top:0;width:49cqw;height:49cqw;object-fit:contain;object-position:right top}.psm-emov2-pres .cast-art{position:absolute;z-index:5;right:1.1cqw;bottom:1.5cqw;width:50cqw;height:17.2cqw;object-fit:contain;filter:drop-shadow(0 .35cqw .7cqw rgba(80,60,45,.08))}.psm-emov2-pres .scene-wash{position:absolute;z-index:2;right:0;top:0;width:50cqw;height:100%;background:linear-gradient(90deg,rgba(254,246,234,.72) 0%,rgba(254,246,234,.10) 22%,rgba(255,229,184,.03) 100%)}
/* lists */
...
/* valores */
.psm-emov2-values .em-head{left:31cqw;top:3.6cqw}.psm-emov2-values .cards{position:absolute;z-index:4;left:23cqw;top:13.2cqw;width:58cqw;display:grid;grid-template-columns:1fr 1.15fr;gap:2.6cqw}.psm-emov2-values .price{background:#ffedaa;border-radius:2.5cqw;padding:2cqw 1.5cqw;text-align:center;box-shadow:0 .35cqw 1.1cqw rgba(105,72,12,.05)}.psm-emov2-values .price span{display:block;color:#2d2927;font:700 1.4cqw/1.15 'Trebuchet MS',Arial,sans-serif}.psm-emov2-values .price strong{display:block;margin-top:.7cqw;color:#10857f;font:800 3.0cqw/1 'Arial Narrow','Trebuchet MS',Arial,sans-serif}.psm-emov2-values .pay{position:absolute;z-index:4;left:24.5cqw;top:36.7cqw;width:62cqw;border-radius:2.8cqw;background:#dfeee7;padding:1.55cqw 3cqw;text-align:center}.psm-emov2-values .pay h3{margin:0 0 .5cqw;color:#70468d;font:700 3cqw 'Segoe Print','Comic Sans MS','Bradley Hand',cursive}.psm-emov2-values .pay .pix{color:#10857f;font:700 2.2cqw 'Trebuchet MS',Arial,sans-serif}.psm-emov2-values .pay p{margin:.5cqw 0 0;font:400 1.18cqw/1.3 'DM Sans',Arial,sans-serif}.psm-emov2-values .em-art{left:1cqw;bottom:-.2cqw;width:19.5cqw;height:30cqw;filter:drop-shadow(0 .35cqw .7cqw rgba(80,60,45,.08))}.psm-emov2-values .em-star.v1{left:6cqw;top:19cqw}.psm-emov2-values .em-star.v2{left:36cqw;top:5.5cqw}.psm-emov2-values .em-heart.v3{left:12cqw;top:12cqw}
/* contato */
.psm-emov2-contact .copy{position:absolute;z-index:5;left:4.6cqw;top:19cqw;width:44cqw}.psm-emov2-contact .copy h3{margin:0 0 3.3cqw;color:#10857f;font:700 2.2cqw 'Trebuchet MS',Arial,sans-serif}.psm-emov2-contact .line{display:flex;align-items:center;gap:1.2cqw;margin:2cqw 0;color:#252226;font:400 1.82cqw 'Trebuchet MS',Arial,sans-serif}.psm-emov2-contact .line .em-icon{width:2.6cqw;height:2.6cqw;color:#4aa88c}.psm-emov2-contact .em-art{right:0;bottom:0;width:54cqw;height:60cqw}.psm-emov2-contact .em-heart.c1{right:29cqw;top:7cqw}.psm-emov2-contact .em-star.c2{right:20cqw;top:10cqw;color:#5abfc6}
/* social */
.psm-emov2-social .handle{position:absolute;z-index:6;left:6.7cqw;top:15.5cqw;display:flex;align-items:center;gap:1cqw;color:#e76386;font:700 2.5cqw 'Trebuchet MS',Arial,sans-serif}.psm-emov2-social .handle .em-icon{width:3.2cqw;height:3.2cqw}.psm-emov2-social .social-main{right:5cqw;bottom:-.1cqw;width:54cqw;height:57cqw}.psm-emov2-social .social-left{left:7cqw;bottom:1.5cqw;width:31cqw;height:28cqw;z-index:5;filter:drop-shadow(0 .35cqw .7cqw rgba(80,60,45,.08))}.psm-emov2-social .em-heart.soc1{right:18cqw;top:8cqw}.psm-emov2-social .em-star.soc2{right:12cqw;top:24cqw}
/* fechamento */
.psm-emov2-close .thanks{position:absolute;z-index:6;left:4.7cqw;top:11.5cqw;color:#70468d;font:700 6.7cqw/.95 'Trebuchet MS',Arial,sans-serif;letter-spacing:-.03em}.psm-emov2-close .name{position:absolute;z-index:6;left:7cqw;top:31cqw;color:#eb6f93;font:700 4.8cqw/.96 'Segoe Print','Comic Sans MS','Bradley Hand',cursive}.psm-emov2-close .badge{position:absolute;z-index:6;left:7cqw;top:49cqw;padding:.9cqw 2.4cqw;border-radius:999px;background:#6db8b2;color:#fff;font:700 1.5cqw 'Trebuchet MS',Arial,sans-serif;letter-spacing:.08em}.psm-emov2-close .crp{position:absolute;z-index:6;left:9.3cqw;top:56cqw;color:#10857f;font:700 1.5cqw 'Trebuchet MS',Arial,sans-serif}.psm-emov2-close .em-art{right:0;bottom:-.1cqw;width:62cqw;height:48cqw;filter:drop-shadow(0 .45cqw .8cqw rgba(80,60,45,.07))}.psm-emov2-close .em-heart.cl1{right:19cqw;top:7cqw}.psm-emov2-close .em-heart.cl2{right:8cqw;top:14cqw}.psm-emov2-close .em-star.cl3{right:27cqw;top:21cqw}
...
function psmPdfHtmlLegacy(publico,individual,pacote){
  ...
  const slides=Array.from({length:10},(_,i)=>{
    ...
    const folder=psmStaticFolder(publico);
    const img=dataUri(readFileSync(new URL(`../assets/psm/${folder}/page-${n}.png`,import.meta.url)),'image/png');
    const overlay=publico==='infantil'&&i===6
      ?`<div class="psm-kids-values"><div class="psm-kids-value one">${escHtml(valorBR(individual)||'R$ 0,00')}</div><div class="psm-kids-value four">${escHtml(valorBR(pacote)||'R$ 0,00')}</div></div>`
      :i===6?`<div class="psm-price-overlay"><span>1 sessão</span><span>${escHtml(valorBR(individual)||'R$ 0,00')}</span><span>Pacote com 4 sessões</span><span>${escHtml(valorBR(pacote)||'R$ 0,00')}</span></div>`:'';
...
.psm-kids-value{position:absolute;color:#0a837f;font:700 31pt Agrandir,Arial Narrow,sans-serif;line-height:1;letter-spacing:-.02em;text-align:center;white-space:nowrap}
.psm-kids-value.one{left:22.7%;top:47.9%;width:21.4%}
.psm-kids-value.four{left:49.1%;top:47.9%;width:24.7%}
</style></head><body>${slides}</body></html>`;
}
