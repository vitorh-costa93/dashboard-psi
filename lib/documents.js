  ...
  for(let i=1;i<=10;i++){
    ...
    if(i===7){
      const svg=`<svg width="2430" height="1620" xmlns="http://www.w3.org/2000/svg">
        <style>.v{font-family:Arial,sans-serif;font-size:92px;font-weight:700;fill:#087f83}</style>
        <text class="v" x="650" y="650" text-anchor="middle">${formatValor(individual)}</text>
        <text class="v" x="1510" y="650" text-anchor="middle">${formatValor(pacote)}</text>
      </svg>`;
