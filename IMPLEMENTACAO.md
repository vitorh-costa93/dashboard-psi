...
### Correção da aplicação da logo — versão atual
- A logo **não é mais desenhada dentro da imagem pela IA**.
- O prompt proíbe explicitamente logo, marca, assinatura e caixa branca.
- A aplicação da identidade visual acontece depois da geração, no navegador.
- O arquivo `assets/logo-jaqueline-dark.png` é PNG RGBA com transparência real.
- A logo é recolorida preservando o canal alpha original.
- **Nenhum fundo, card, moldura ou retângulo branco é desenhado atrás da logo.**
- A posição continua no canto inferior direito, com margem para evitar conflito com o conteúdo.
- A cor continua sendo escolhida por slide a partir da paleta da própria arte.
