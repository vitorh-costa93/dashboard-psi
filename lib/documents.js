...
</div>${psmKidsIllus(publico,1)}</div>`;
}
...
${psmKidsIllus(publico,emoIdx)}</div>`;
}
...
.psm-kids-inline-illus{border-radius:14px;box-shadow:0 4px 14px rgba(0,0,0,.08)}
.psm-kids-illus{position:absolute;right:.6in;bottom:.6in;width:2.5in;height:auto;border-radius:14px;box-shadow:0 4px 14px rgba(0,0,0,.08)}
