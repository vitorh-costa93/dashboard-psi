...
function headerTemplateHtml(title,colorido){
  return `<div style="width:100%;box-sizing:border-box;padding:10px 42px 0;font-family:Arial,sans-serif;-webkit-print-color-adjust:exact;print-color-adjust:exact;">
<table style="border-collapse:collapse;"><tr>
<td style="width:36px;">
<div style="width:32px;height:32px;border-radius:50%;background:${colorido===false?'#b8b8b8':'#b7c3a5'};text-align:center;line-height:32px;">
<img src="${brandSymbolWhiteUri}" style="width:20px;height:18px;vertical-align:middle;filter:brightness(0) invert(1);">
</div>
</td>
<td style="padding-left:8px;font-family:'Arial Narrow',Arial,sans-serif;color:#6b6b70;">
<div style="font-size:12px;font-weight:bold;">Jaqueline Vieira</div>
<div style="font-size:6.5px;font-weight:bold;margin-top:2px;">PSICÓLOGA&nbsp;&nbsp;CRP 06/191478</div>
</td>
</tr></table>
<div style="text-align:center;font-size:11.5px;font-weight:bold;color:#626267;margin:6px 0;font-family:'Arial Narrow',Arial,sans-serif;">${escHtml(title)}</div>
<div style="border-bottom:1px solid #9aa7aa;"></div>
</div>`;
}
