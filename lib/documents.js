...
const PSM_TOYS=[
  ...
  {name:'Pipa',bg:'#e4eef7',fg:'#6e9dc4',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3 18 10 12 21 6 10z" fill="currentColor" fill-opacity=".12"/><path d="M6 10h12M12 3v18"/><path d="M12 21c.8.9.8 1.8 0 2.7"/></svg>'},
  {name:'Bola',bg:'#fbe4e1',fg:'#d97066',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"><circle cx="12" cy="12" r="8" fill="currentColor" fill-opacity=".12"/><path d="M12 4c3 3 3 13 0 16M4 12c3-3 13-3 16 0"/></svg>'},
  {name:'Balão',bg:'#eee6f7',fg:'#a784cc',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2.5c4.2 0 7 3.3 7 7.3S16.4 17 12 17s-7-3.2-7-7.2 2.8-7.3 7-7.3z" fill="currentColor" fill-opacity=".12"/><path d="M12 17l-1.3 2 1.3 1.3-1.3 2"/></svg>'},
